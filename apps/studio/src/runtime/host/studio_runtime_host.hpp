...
#include "runtime/api/runtime_registry.hpp"
#include "runtime/api/game_runtime_library.hpp"
#include "runtime/host/studio_connector.hpp"
#include "runtime/interaction/studio_interaction_controller.hpp"
#include "runtime/interaction/studio_picking_service.hpp"
#include "runtime/scene/proxy_prototype_resolver.hpp"
...
namespace studio_runtime
{
    ...
    public:
        ...
        bool RegisterScriptPrototype(const engine::script::ScriptPrototype& prototype);
        void SetScriptLogSink(std::function<void(const std::string&)> sink);
        void SetScriptEventSink(std::function<void(const engine::script::ScriptEvent&)> sink);
    ...
    private:
        ...
        GameRuntimeLibrary m_runtimeLibrary;
        IGameRuntime* m_activeRuntime = nullptr;
        ...
        std::function<void(const engine::script::ScriptEvent&)> m_scriptEventSink;
